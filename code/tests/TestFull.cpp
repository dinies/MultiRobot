// Created by Edoardo Ghini on 03/12/2018.
...
namespace MultiRobot{
  ...
  TEST( OneCamTest, full){
    ...
    double fps = 60.0;
    std::string videopath  = "../videos/Full.avi";
